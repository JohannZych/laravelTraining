...
@section('content')
    ...
    <div class="alert alert-warning" role="warning">
        <h4 class="alert-heading">Are you sure you want to delete this movie
            ?</h4>
    </div>
    <form>
        <button type="submit" value="delete" class="btn btn-primary">Delete
        </button>
    </form>
    <ul class="list-inline list-unstyled mt-5">
        ...
        <a href="{{ route('backoffice.movies.edit', [ 'id' => $movie['id'] ])
}}" class="btn btn-outline-secondary btn-sm btn-sm">Edit</a>
