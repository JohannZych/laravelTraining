                ...
                <td>
                    <ul class="list-inline list-unstyled">
                        <li class="list-inline-item">
                            <a href="{{ route('backoffice.movies.show', ['id' => $movie['id']]) }}">Show</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ route('backoffice.movies.edit', ['id' => $movie['id']]) }}">Edit</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ route('backoffice.movies.delete', ['id' => $movie['id']])}}">Delete</a>
                        </li>
                    </ul>
                </td>
            </tr>
